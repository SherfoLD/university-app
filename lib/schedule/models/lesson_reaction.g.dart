...
LessonReaction _$LessonReactionFromJson(Map<String, dynamic> json) =>
    LessonReaction(
...
Map<String, dynamic> _$LessonReactionToJson(LessonReaction instance) =>
    <String, dynamic>{
...
LessonReactionSummary _$LessonReactionSummaryFromJson(
  ...
  reactionCounts: (json['reactionCounts'] as Map<String, dynamic>).map(
    (k, e) =>
        MapEntry($enumDecode(_$ReactionTypeEnumMap, k), (e as num).toInt()),
  ),
...
Map<String, dynamic> _$LessonReactionSummaryToJson(
  LessonReactionSummary instance,
) => <String, dynamic>{
  'subjectName': instance.subjectName,
  'lessonDate': instance.lessonDate.toIso8601String(),
  'lessonBells': instance.lessonBells,
  'reactionCounts': instance.reactionCounts.map(
    (k, e) => MapEntry(_$ReactionTypeEnumMap[k]!, e),
  ),
