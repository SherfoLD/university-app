...
_$ScheduleStateImpl _$$ScheduleStateImplFromJson(
            ...
            (e) => _$recordConvert(
              ...
              ($jsonValue) => (
                ...
                ($jsonValue[r'$3'] as List<dynamic>)
                    .map(
                      (e) => SchedulePart.fromJson(e as Map<String, dynamic>),
                    )
                    .toList(),
              ),
            ),
...
Map<String, dynamic> _$$ScheduleStateImplToJson(
  _$ScheduleStateImpl instance,
) => <String, dynamic>{
  'classroomsSchedule':
      instance.classroomsSchedule
          .map((e) => <String, dynamic>{r'$1': e.$1, r'$2': e.$2, r'$3': e.$3})
          .toList(),
  'teachersSchedule':
  ...
  'reactionSummaries': instance.reactionSummaries,
